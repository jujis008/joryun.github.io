...
/*			error:function(XMLHttpRequest, textStatus, errorThrown){
	...
	return {
		init:function(){
			...
			// 	return;
			// }
			getList("https://api.instagram.com/v1/users/self/?access_token=3632186935.3ade026.8ad36a8b688c43a38bdc0e4fe8580c94");
			bind();
		}
	}
})();
$(function(){
	$('<a href="https://instagram.com/joryun_liu" target="_blank" class="open-ins" style="float:right;font-size:15px;color:#6E7173;margin-top:10px">图片来自我的Instagram，点此访问</a>').appendTo($(".post-title"));
	Instagram.init();
})